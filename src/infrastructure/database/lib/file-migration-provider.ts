/**
 * kysely from cdn fails when importing local modules with dynamic import (at line L40)
 * resolution is use local FileMigrationProvider class
 * https://github.com/koskimas/kysely/blob/master/src/migration/file-migration-provider.ts
 */

import { Migration, MigrationProvider } from 'kysely';
import { isFunction, isObject } from '../../../utils/object-utils.ts';
